...
```javascript
import FLOAT32_LN2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-ln-two@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-ln-two/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-ln-two/actions/workflows/test.yml?query=branch:v0.1.1
